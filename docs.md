...
* `1164-grades.pdf` has odd "#Error" values on pages 419, 423, and 425

* `1224-dir.pdf` splits an instructor's name over pages 527 and 528

* `1232-grades.pdf` has odd "#Type!" error-looking values on pages 395, 436, and 440

* Several grades reports have unlabelled rows above the Freshman row in the summary section
